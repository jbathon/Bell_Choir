...
/*
 * All the Notes that the program can play.
 */
public enum Note {
...
enum NoteLength {
  WHOLE(1.0f), HALF(0.5f), QUARTER(0.25f), SIXTH(0.1667f), EIGTH(0.125f), SIXTEENTH(0.0625f);
  ...
  /*
   * All length of notes that the program can play.
   */
